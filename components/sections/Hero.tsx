      ...
      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <p className="text-xl text-zinc-400 mb-10 max-w-lg leading-relaxed">
            Redefiniendo la arquitectura modular. Transformamos estructuras industriales en espacios
            habitables de alto rendimiento y lujo sostenible.
          </p>
        ...
        >
          ...
          <div className="absolute -top-6 -right-6 bg-orange-600 p-6 rounded-lg shadow-xl z-20 hidden xl:block">
            ...
            <p className="text-xs font-mono uppercase tracking-widest text-orange-100">
